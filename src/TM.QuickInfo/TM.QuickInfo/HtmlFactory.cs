...
namespace TM.QuickInfo
{
    public class HtmlFactory
    {
        ...
        public static string TableStart(string tableClass = "", string tableStyle = "")
        {
            return TagStart("table", tableClass, tableStyle);
        }

        public static string TagStart(string tag, string tagClass = "", string tagStyle = "", params (string, string)[] attributes)
        {
        ...
        public static string WrapInAttribute(string attributeName, string attributeValue)
        {
